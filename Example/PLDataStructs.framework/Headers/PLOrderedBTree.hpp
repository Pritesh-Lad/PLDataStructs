...
/**
 * This class defines an ordered binary tree implementation.
 * This is also known as Binary Search Tree(BST).
 */
...
public :
    ...
    /**
     * Initializes an ordered tree with the list of nodes.
    ...
    /**
     * @return The right subtree of the ordered binary tree.
     */
    virtual PLOrderedBTree * getRightSubtree();

    /**
     * Inserts a node into the current ordered binary tree.
